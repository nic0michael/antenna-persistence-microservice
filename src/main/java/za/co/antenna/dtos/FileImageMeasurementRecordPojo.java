...
public class FileImageMeasurementRecordPojo {
	private String fileMeasurementId;
	private String antennaCode;
	private String determinant;
	private String value;
	
	public FileImageMeasurementRecordPojo() {}

	public FileImageMeasurementRecordPojo(String antennaCode,
			 							  String determinant,
			 							  String value) {
		super();
	...
	public String toString() {
		return "FileImageMeasurementRecordPojo [fileMeasurementId=" +
				fileMeasurementId +
				", antennaCode=" +
				antennaCode +
				", determinant=" +
